...
const BrandList = () => {
  ...
  useEffect(() => {
    axios
      .get(
        "https://flooring-deals-admin-backend.onrender.com/api/brand/getAll",
        data
      )
      .then((res) => {
  ...
  const handleDeleteRow = (id) => {
    ...
    axios
      .delete(
        `https://flooring-deals-admin-backend.onrender.com/api/brand/${id}`
      )
  ...
  useEffect(() => {
    axios
      .get(
        `https://flooring-deals-admin-backend.onrender.com/api/brand/get/${id}`
      )
      .then((res) => {
        const response = res;
          ...
          <div class="modal-content">
            ...
            <div class="modal-footer">
              ...
              <button
                ...
                onClick={(e) => handleDeleteRow(brandid)}
              >
                Delete
              </button>
            </div>
        ...
        {currentCards.length > 0 &&
          currentCards.map?.((item) => {
            return (
              <>
                <div
                  class=" card border-0 shadow p-2 mb-5 bg-body-tertiary rounded"
                  style={{ width: "18rem", backgroundColor: "#f7f6ed" }}
                >
                  ...
                  <div class="card-body text-end">
                    <Link
                      ...
                      type="button"
                      class="btn btn-primary border-0 text-dark"
                      style={{ backgroundColor: "#ced4da", width: "4rem" }}
                    >
                      Edit
                    </Link>
                    <Link
