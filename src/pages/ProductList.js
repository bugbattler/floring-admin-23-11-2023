...
const ProductList = () => {
  ...
  useEffect(() => {
    axios
      .get(
        "https://flooring-deals-admin-backend.onrender.com/api/product/getAll"
      )
      .then((res) => {
  ...
  const handleDeleteRow = (id) => {
    ...
    axios
      .delete(
        `https://flooring-deals-admin-backend.onrender.com/api/product/delete/${id}`
      )
      .then((response) => {
