...
const Products = () => {
    ...
    if (Object.keys(err).length == 0) {
      {
        axios
          .post(
            "https://flooring-deals-admin-backend.onrender.com/api/product/create",
            data
          )
          .then((response) => {
  ...
  const uploadProductPic = (id) => {
    ...
    axios
      .put(
        `https://flooring-deals-admin-backend.onrender.com/api/product/files/${id}`,
        formData
      )
  ...
  useEffect(() => {
    ...
    axios
      .get("https://flooring-deals-admin-backend.onrender.com/api/brand/getAll")
      .then((res) => {
  ...
  useEffect(() => {
    axios
      .get(
        `https://flooring-deals-admin-backend.onrender.com/api/product/${id}`
      )
      .then((res) => {
  ...
  const updateFormData = (e) => {
    axios
      .put(
        `https://flooring-deals-admin-backend.onrender.com/api/product/update/${id}`,
        data
      )
      .then((res) => {
        const response = res.data;
