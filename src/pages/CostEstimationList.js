...
const CostEstimationList = () => {
  ...
  const handlePageClick = (id) => {
    axios
      .get(
        `https://flooring-deals-admin-backend.onrender.com/api/cost/get/${id}`
      )
      .then((res) => {
        console.log(104, res.data);
        setData(res.data);
  ...
  const handleDeleteRow = (id) => {
    ...
    axios
      .delete(
        `https://flooring-deals-admin-backend.onrender.com/api/cost/delete/${id}`
      )
      .then((response) => {
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <h6 className="" style={{ fontSize: "18px" }}>
                ...
                <span className="fw-bold">{costName}</span> Item ?
              </h6>
            </div>
            <div class="modal-footer">
              ...
              <button
                ...
                onClick={(e) => handleDeleteRow(costId)}
              >
                Delete
              </button>
            </div>
