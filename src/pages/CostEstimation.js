...
const CostEstimation = () => {
  ...
  useEffect(() => {
    axios
      .get("https://flooring-deals-admin-backend.onrender.com/api/cost/get")
      .then((res) => {
  ...
  const SaveData = (e) => {
    ...
    axios
      .post(
        "https://flooring-deals-admin-backend.onrender.com/api/cost/create",
        data
      )
    ...
    <>
      <div className="">
        ...
        >
          ...
          <option style={{ background: "white" }} value="Main">
            Main
          </option>
          <option style={{ background: "white" }} value="Sub">
            Sub
          </option>
        </select>
      </div>
          ...
          >
            <div class="col-md-7">
              ...
              <input
                ...
                onChange={(e) => {
                  setData({ ...data, name: e.target.value, type: "parent" });
                }}
              />
            </div>
            ...
            <div class="col-lg-12">
              ...
              >
                ...
                {maindata.map((item) => {
                  return (
                    <>
                      <option value={item._id} style={{ background: "white" }}>
                        {item.name}
                      </option>
                    </>
                  );
