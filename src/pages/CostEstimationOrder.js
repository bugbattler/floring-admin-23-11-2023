...
const CostEstimationOrder = () => {
  ...
  useEffect(() => {
    axios
      .get(`https://flooring-deals-admin-backend.onrender.com/api/order/${id}`)
      .then((res) => {
