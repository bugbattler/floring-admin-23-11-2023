...
const Category = () => {
  ...
  const uploadimage = (id) => {
    ...
    axios
      .put(
        `https://flooring-deals-admin-backend.onrender.com/api/addressProof/${id}`,
        formData
      )
  ...
  useEffect(() => {
    axios
      .get("https://flooring-deals-admin-backend.onrender.com/api/category/get")
      .then((res) => {
  ...
  const SaveCAt = (e) => {
    ...
    axios
      .post(
        "https://flooring-deals-admin-backend.onrender.com/api/category/createTemp",
        data
      )
      .then((res) => {
        const response = res.data.categories;
  ...
  return (
    <div>
      ...
      <select
        class="form-select fw-medium form-select w-25 mb-3"
        style={{ width: "260px", backgroundColor: "#dce1e5", color: "black" }}
      ...
      >
        ...
        <option
          style={{ background: "white", color: "black", textAlign: "left" }}
          value="Main Category"
        >
          Main Category
        </option>
            ...
            <div class="col-md-4">
              ...
              <select
                ...
                onChange={(e) => {
                  ...
                  console.log("ok");
                  getCat(
                    AllSuperCat.find((item) => item.name === selectedValue)._id
                  );
                }}
              >
                <option
